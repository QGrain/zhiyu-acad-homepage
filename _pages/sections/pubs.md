...
- **[USENIX Security 2023]**: [CarpetFuzz: Automatic Program Option Constraint Extraction from Documentation for Fuzzing](https://www.usenix.org/conference/usenixsecurity23/presentation/wang-dawei)
    
    Dawei Wang, Ying Li, **Zhiyu Zhang**, Kai Chen | [PDF](https://www.usenix.org/system/files/usenixsecurity23-wang-dawei.pdf) | [CODE](https://github.com/waugustus/CarpetFuzz)
